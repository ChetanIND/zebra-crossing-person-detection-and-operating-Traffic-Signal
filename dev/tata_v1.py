            ...
            for result in results:
                for i in range(number_of_objects):
                    ...
                    if name == "person":
                        ...
                        person_inside_polygon1 = cv2.pointPolygonTest(vertices, (person_x, person_y+30), False)
                        ...
                        if person_inside_polygon1 > 0:
                            ...
                            cv2.circle(frame, (person_x, person_y+30),5, (0, 255, 255),-1)
                            cv2.circle(frame, (person_x, person_y+30), 7, (0, 0, 0), 2)

                        else:
                            cv2.putText(frame, "P:outside", (person_x-30, person_y-20), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 255, 255), 1, cv2.LINE_AA)
                            cv2.circle(frame, (person_x, person_y+30),5, (0, 255, 0), -1)
