...
person_model_path = r"C:\Users\mkrob\Desktop\TATA\assest\yolov8_models\yolov8n.pt"
mobile_model_path = r"C:\Users\mkrob\Desktop\TATA\assest\yolov8_models\mobile_model.pt"
...
def stream1():
    ...
    # camera link
    camera_link = r"rtsp://admin:Mk123456@169.254.7.182:554/Streaming/Channels/102"
    ...
    while True:
        ...
        person_results = person_model(frame, conf=0.3, verbose=False)
        ...
        if mobile_results and len(mobile_results[0].boxes) > 0:
            ...
            for result in mobile_results:
                for i in range(number_of_objects):
                    ...
                    tts_thread = threading.Thread(target=tts_task, args=("Don't use the mobile avoid accidents",))
                    tts_thread.start()
