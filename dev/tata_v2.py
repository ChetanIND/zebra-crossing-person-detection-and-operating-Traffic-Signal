...
model_path = r"D:\projects\09_TATA MOTORS\tata vision perimeter\assets\yolov8_models\yolov8n.pt"
...
def stream1():
    ...
    status_counter = 0
    person_inside = False  # Flag to track if a person is detected inside the polygon
                ...
                for i in range(number_of_objects):
                    ...
                    if name == "person":
                        ...
                        if person_inside_polygon1 > 0:
                            person_inside = True  # Update the flag
                            ...
                            cv2.circle(frame, (person_x, person_feet_y), 5, (0, 0, 255), -1)  # Red circle when detected
                            cv2.circle(frame, (person_x, person_feet_y), 7, (0, 0, 0), 2)

                        else:
                            person_inside = False  # Reset the flag
                            cv2.putText(frame, "P:outside", (person_x - 30, person_y - 20), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 255, 255), 1, cv2.LINE_AA)
                            cv2.circle(frame, (person_x, person_feet_y), 5, (0, 255, 0), -1)  # Green circle when outside
